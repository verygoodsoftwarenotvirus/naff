...
func oauth2ClientsTestDotGo() *jen.File {
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildGetOAuth2ClientByClientIDQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_GetOAuth2ClientByClientID").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildGetAllOAuth2ClientsQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_GetAllOAuth2Clients").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_GetAllOAuth2ClientsForUser").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildGetOAuth2ClientQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_GetOAuth2Client").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildGetOAuth2ClientCountQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_GetOAuth2ClientCount").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildGetAllOAuth2ClientCountQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_GetAllOAuth2ClientCount").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildGetOAuth2ClientsQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_GetOAuth2Clients").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildCreateOAuth2ClientQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_CreateOAuth2Client").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildUpdateOAuth2ClientQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_UpdateOAuth2Client").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_buildArchiveOAuth2ClientQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestMariaDB_ArchiveOAuth2Client").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
