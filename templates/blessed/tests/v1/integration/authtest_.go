	...
	ret.Add(
		jen.Func().ID("TestAuth").Params(jen.ID("test").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("test").Dot("Run").Call(jen.Lit("should be able to login"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.Line(),
				jen.List(jen.ID("u"), jen.ID("err")).Op(":=").Qual("net/url", "Parse").Call(jen.IDf("%sClient", pkg.Name.UnexportedVarName()).Dot("BuildURL").Call(jen.ID("nil"))),
				jen.Qual("github.com/stretchr/testify/require", "NoError").Call(jen.ID("t"), jen.ID("err")),
			...
			jen.ID("test").Dot("Run").Call(jen.Lit("should be able to logout"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.List(jen.ID("u2"), jen.ID("err")).Op(":=").Qual("net/url", "Parse").Call(jen.IDf("%sClient", pkg.Name.UnexportedVarName()).Dot("BuildURL").Call(jen.ID("nil"))),
				jen.Qual("github.com/stretchr/testify/require", "NoError").Call(jen.ID("t"), jen.ID("err")),
			...
			jen.ID("test").Dot("Run").Call(jen.Lit("should reject an unauthenticated request"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				jen.List(jen.ID("req"), jen.ID("err")).Op(":=").Qual("net/http", "NewRequest").Call(jen.Qual("net/http", "MethodGet"), jen.IDf("%sClient", pkg.Name.UnexportedVarName()).Dot("BuildURL").Call(jen.ID("nil"), jen.Lit("webhooks")), jen.ID("nil")),
				jen.Qual("github.com/stretchr/testify/assert", "NoError").Call(jen.ID("t"), jen.ID("err")),
				jen.Line(),
				jen.List(jen.ID("res"), jen.ID("err")).Op(":=").ID("todoClient").Dot("PlainClient").Call().Dot("Do").Call(jen.ID("req")),
				jen.Qual("github.com/stretchr/testify/assert", "NoError").Call(jen.ID("t"), jen.ID("err")),
			...
			jen.ID("test").Dot("Run").Call(jen.Lit("should be able to change password"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.Line(),
				jen.List(jen.ID("u3"), jen.ID("err")).Op(":=").Qual("net/url", "Parse").Call(jen.IDf("%sClient", pkg.Name.UnexportedVarName()).Dot("BuildURL").Call(jen.ID("nil"))),
				jen.Qual("github.com/stretchr/testify/require", "NoError").Call(jen.ID("t"), jen.ID("err")),
