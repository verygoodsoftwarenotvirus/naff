	...
	ret.Add(
		jen.Func().ID("TestService_Create").Params(jen.ID("T").ParamPointer().Qual("testing", "T")).Block(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("s").Assign().ID("buildTestService").Call(jen.ID("t")),
				jen.Line(),
				jen.ID("exampleInput").Assign().AddressOf().Qual(proj.ModelsV1Package(), "UserInput").Valuesln(
	...
	ret.Add(
		jen.Func().ID("TestService_NewTOTPSecret").Params(jen.ID("T").ParamPointer().Qual("testing", "T")).Block(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("s").Assign().ID("buildTestService").Call(jen.ID("t")),
				jen.Line(),
				jen.ID("exampleInput").Assign().AddressOf().Qual(proj.ModelsV1Package(), "TOTPSecretRefreshInput").Values(),
	...
	ret.Add(
		jen.Func().ID("TestService_UpdatePassword").Params(jen.ID("T").ParamPointer().Qual("testing", "T")).Block(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("exampleInput").Assign().AddressOf().Qual(proj.ModelsV1Package(), "PasswordUpdateInput").Valuesln(
