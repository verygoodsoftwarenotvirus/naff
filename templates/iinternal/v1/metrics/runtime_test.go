...
func Test_float64Metric(T *testing.T) {
	T.Parallel()
	...
	T.Run("obligatory", func(t *testing.T) {
		...
		x := float64Metric(varName, measurementName, description, count)
...
func main() {
	// RuntimeexampleMeasurement captures the runtime memstats example field.
	RuntimeexampleMeasurement = stats.Float64(
		"measurement name",
		"obligated description",
		stats.UnitDimensionless,
	)
	// RuntimeexampleView is the corresponding view for the above field.
	RuntimeexampleView = &view.View{
		Name:        "measurement name",
		Measure:     RuntimeexampleMeasurement,
		Description: "obligated description",
...
func Test_int64Metric(T *testing.T) {
	T.Parallel()
	...
	T.Run("obligatory", func(t *testing.T) {
		...
		x := int64Metric(varName, measurementName, description, count)
...
func main() {
	// RuntimeexampleMeasurement captures the runtime memstats example field.
	RuntimeexampleMeasurement = stats.Int64(
		"measurement name",
		"obligated description",
		stats.UnitDimensionless,
	)
...
func Test_viewDotView(T *testing.T) {
	T.Parallel()
	...
	T.Run("obligatory", func(t *testing.T) {
		...
		description := "obligated description"
		measurementName := "measurement name"
		measurementVarName := "measurementVarName"
		count := true

		x := viewDotView(viewName, measurementName, measurementVarName, description, count)
...
func Test_statsDotFloat64(T *testing.T) {
	T.Parallel()
	...
	T.Run("obligatory", func(t *testing.T) {
		...
		x := statsDotFloat64(varName, measurementName, description)
...
func Test_statsDotInt64(T *testing.T) {
	T.Parallel()
	...
	T.Run("obligatory", func(t *testing.T) {
		...
		x := statsDotInt64(varName, measurementName, description)
...
func Test_runtimeDotGo(T *testing.T) {
	T.Parallel()
...
func Test_buildRuntimeVarDeclarations(T *testing.T) {
	T.Parallel()
...
func Test_buildRuntimeRegisterDefaultViews(T *testing.T) {
	T.Parallel()
...
func Test_buildRuntimeRecordRuntimeStats(T *testing.T) {
	T.Parallel()
