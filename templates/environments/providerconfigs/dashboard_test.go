...
func Test_dashboardDotJSON(T *testing.T) {
	T.Parallel()
  ...
  "panels": [
    ...
    },
    {
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "time spent collecting metrics ",
      "tooltip": {
        "shared": true,
        "sort": 0,
        "value_type": "individual"
...
`
		actual := dashboardDotJSON(project)
