...
func TestV1Client_GetWebhook(T *testing.T) {
	T.Parallel()
	T.Run("happy path", func(t *testing.T) {
		expected := &models.Webhook{ID: 1, Name: "example"}
		ctx := context.Background()
...
func TestV1Client_GetWebhooks(T *testing.T) {
	T.Parallel()
	T.Run("happy path", func(t *testing.T) {
		expected := &models.WebhookList{Webhooks: []models.Webhook{{ID: 1, Name: "example"}}}
		ctx := context.Background()
		ts := httptest.NewTLSServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
...
func TestV1Client_BuildCreateWebhookRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		ctx := context.Background()
		ts := httptest.NewTLSServer(nil)
		exampleInput := &models.WebhookCreationInput{Name: "expected name"}
		c := buildTestClient(t, ts)
...
func TestV1Client_BuildUpdateWebhookRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		ctx := context.Background()
		exampleInput := &models.Webhook{Name: "changed name"}
		ts := httptest.NewTLSServer(nil)
		c := buildTestClient(t, ts)
