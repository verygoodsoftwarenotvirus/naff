...
func TestV1Client_GetOAuth2Client(T *testing.T) {
	T.Parallel()
	T.Run("happy path", func(t *testing.T) {
		expected := &models.OAuth2Client{ID: 1, ClientID: "example", ClientSecret: "blah"}
		ctx := context.Background()
...
func TestV1Client_GetOAuth2Clients(T *testing.T) {
	T.Parallel()
	T.Run("happy path", func(t *testing.T) {
		expected := &models.OAuth2ClientList{Clients: []models.OAuth2Client{{ID: 1, ClientID: "example", ClientSecret: "blah"}}}
		ctx := context.Background()
		ts := httptest.NewTLSServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
...
func TestV1Client_BuildCreateOAuth2ClientRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		ts := httptest.NewTLSServer(nil)
		c := buildTestClient(t, ts)
		exampleInput := &models.OAuth2ClientCreationInput{UserLoginInput: models.UserLoginInput{Username: "username", Password: "password", TOTPToken: "123456"}}
...
func TestV1Client_CreateOAuth2Client(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		ctx := context.Background()
		exampleInput := &models.OAuth2ClientCreationInput{UserLoginInput: models.UserLoginInput{Username: "username", Password: "password", TOTPToken: "123456"}}
		exampleOutput := &models.OAuth2Client{ClientID: "EXAMPLECLIENTID", ClientSecret: "EXAMPLECLIENTSECRET"}
		ts := httptest.NewTLSServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
