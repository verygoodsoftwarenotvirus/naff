...
func loggerDotGo(proj *models.Project) *jen.File {
	...
	code.Add(
		jen.Type().ID("logger").Struct(
			jen.ID("requestIDFunc").ID("logging").Dot("RequestIDFunc"),
	...
	code.Add(
		jen.Comment("NewLogger builds a new logger."),
		jen.Line(),
		jen.Func().ID("NewLogger").Params().Params(jen.ID("logging").Dot("Logger")).Body(
			jen.Return().Op("&").ID("logger").Valuesln(
				jen.ID("logger").Op(":").ID("buildZerologger").Call())),
		jen.Line(),
	)
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("WithName").Params(jen.ID("name").ID("string")).Params(jen.ID("logging").Dot("Logger")).Body(
			jen.ID("l2").Op(":=").ID("l").Dot("logger").Dot("With").Call().Dot("Str").Call(
				jen.ID("logging").Dot("LoggerNameKey"),
				jen.ID("name"),
			).Dot("Logger").Call(),
			jen.Return().Op("&").ID("logger").Valuesln(
				jen.ID("logger").Op(":").ID("l2")),
		),
		jen.Line(),
	)

	code.Add(
		jen.Comment("SetLevel sets the log level for our logger."),
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("SetLevel").Params(jen.ID("level").ID("logging").Dot("Level")).Body(
			jen.Var().ID("lvl").ID("zerolog").Dot("Level"),
			jen.Switch(jen.ID("level")).Body(
				jen.Case(jen.ID("logging").Dot("InfoLevel")).Body(
					jen.ID("lvl").Op("=").ID("zerolog").Dot("InfoLevel")),
				jen.Case(jen.ID("logging").Dot("DebugLevel")).Body(
					jen.ID("l").Dot("logger").Op("=").ID("l").Dot("logger").Dot("With").Call().Dot("Logger").Call(), jen.ID("lvl").Op("=").ID("zerolog").Dot("DebugLevel")),
				jen.Case(jen.ID("logging").Dot("WarnLevel")).Body(
				...
				jen.Case(jen.ID("logging").Dot("ErrorLevel")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("SetRequestIDFunc").Params(jen.ID("f").ID("logging").Dot("RequestIDFunc")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("Info").Params(jen.ID("input").ID("string")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("Debug").Params(jen.ID("input").ID("string")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("Error").Params(jen.ID("err").ID("error"), jen.ID("input").ID("string")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("Fatal").Params(jen.ID("err").ID("error")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("Printf").Params(jen.ID("format").ID("string"), jen.ID("args").Op("...").Interface()).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("Clone").Params().Params(jen.ID("logging").Dot("Logger")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("WithValue").Params(jen.ID("key").ID("string"), jen.ID("value").Interface()).Params(jen.ID("logging").Dot("Logger")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("WithValues").Params(jen.ID("values").Map(jen.ID("string")).Interface()).Params(jen.ID("logging").Dot("Logger")).Body(
			jen.Var().ID("l2").Op("=").ID("l").Dot("logger").Dot("With").Call().Dot("Logger").Call(),
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("WithError").Params(jen.ID("err").ID("error")).Params(jen.ID("logging").Dot("Logger")).Body(
	...
	code.Add(
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("attachRequestToLog").Params(jen.ID("req").Op("*").Qual("net/http", "Request")).Params(jen.ID("zerolog").Dot("Logger")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("WithRequest").Params(jen.ID("req").Op("*").Qual("net/http", "Request")).Params(jen.ID("logging").Dot("Logger")).Body(
			jen.Return().Op("&").ID("logger").Valuesln(
				jen.ID("logger").Op(":").ID("l").Dot("attachRequestToLog").Call(jen.ID("req")))),
		jen.Line(),
	)
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("l").Op("*").ID("logger")).ID("WithResponse").Params(jen.ID("res").Op("*").Qual("net/http", "Response")).Params(jen.ID("logging").Dot("Logger")).Body(
			jen.ID("l2").Op(":=").ID("l").Dot("logger").Dot("With").Call().Dot("Logger").Call(),
