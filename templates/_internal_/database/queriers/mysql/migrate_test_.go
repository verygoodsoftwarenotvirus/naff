		...
		jen.Func().ID("TestQuerier_Migrate").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("exampleTestUserConfig").Op(":=").Op("&").ID("types").Dot("TestUserCreationConfig").Valuesln(jen.ID("Username").Op(":").ID("exampleUser").Dot("Username"), jen.ID("Password").Op(":").ID("exampleUser").Dot("HashedPassword"), jen.ID("HashedPassword").Op(":").ID("exampleUser").Dot("HashedPassword"), jen.ID("IsServiceAdmin").Op(":").ID("true")),
