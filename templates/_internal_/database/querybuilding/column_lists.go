...
func columnListsDotGo(proj *models.Project) *jen.File {
	...
	code.Add(
		jen.Var().Defs(
			jen.ID("AccountsUserMembershipTableColumns").Op("=").Index().ID("string").Valuesln(jen.Qual("fmt", "Sprintf").Call(
				jen.Lit("%s.%s"),
			...
			jen.ID("AccountsTableColumns").Op("=").Index().ID("string").Valuesln(jen.Qual("fmt", "Sprintf").Call(
				jen.Lit("%s.%s"),
			...
			jen.ID("UsersTableColumns").Op("=").Index().ID("string").Valuesln(jen.Qual("fmt", "Sprintf").Call(
				jen.Lit("%s.%s"),
			...
			jen.ID("AuditLogEntriesTableColumns").Op("=").Index().ID("string").Valuesln(jen.Qual("fmt", "Sprintf").Call(
				jen.Lit("%s.%s"),
			...
			jen.ID("APIClientsTableColumns").Op("=").Index().ID("string").Valuesln(jen.Qual("fmt", "Sprintf").Call(
				jen.Lit("%s.%s"),
			...
			jen.ID("WebhooksTableColumns").Op("=").Index().ID("string").Valuesln(jen.Qual("fmt", "Sprintf").Call(
				jen.Lit("%s.%s"),
			...
			jen.ID("ItemsTableColumns").Op("=").Index().ID("string").Valuesln(jen.Qual("fmt", "Sprintf").Call(
				jen.Lit("%s.%s"),
