...
func mockAccountUserMembershipSQLQueryBuilderDotGo(proj *models.Project) *jen.File {
	...
	code.Add(
		jen.Var().ID("_").ID("querybuilding").Dot("AccountUserMembershipSQLQueryBuilder").Op("=").Parens(jen.Op("*").ID("AccountUserMembershipSQLQueryBuilder")).Call(jen.ID("nil")),
		jen.Line(),
	)

	code.Add(
		jen.Type().ID("AccountUserMembershipSQLQueryBuilder").Struct(jen.ID("mock").Dot("Mock")),
		jen.Line(),
	)
