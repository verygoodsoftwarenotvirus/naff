					...
					jen.ID("cfg").Op(":=").Op("&").ID("Config").Valuesln(
						jen.ID("Storage").Op(":").ID("storage").Dot("Config").Valuesln(
							jen.ID("FilesystemConfig").Op(":").Op("&").ID("storage").Dot("FilesystemConfig").Valuesln(
								...
								jen.ID("BucketName").Op(":").Lit("blahs")), jen.ID("BucketName").Op(":").Lit("blahs"), jen.ID("UploadFilenameKey").Op(":").Lit("blahs"), jen.ID("Provider").Op(":").Lit("blahs")), jen.ID("Debug").Op(":").ID("false")),
