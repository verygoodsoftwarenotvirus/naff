	...
	lines := []jen.Code{
		jen.Func().ID("TestService_validateCredentialChangeRequest").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTest(
				...
				jen.Qual(proj.InternalAuthPackage(), "On").Callln(
			...
			utils.BuildSubTest(
				...
				jen.ID("mockDB").Dot("UserDataManager").Dot("On").Call(
					...
					jen.Qual(constants.MockPkg, "Anything"),
					jen.ID(utils.BuildFakeVarName("User")).Dot("ID"),
				).Dot("Return").Call(jen.Parens(jen.PointerTo().Qual(proj.TypesPackage(), "User")).Call(jen.Nil()), jen.Qual("database/sql", "ErrNoRows")),
				jen.ID("s").Dot("userDataManager").Equals().ID("mockDB"),
				jen.Line(),
				jen.List(jen.ID("actual"), jen.ID("sc")).Assign().ID("s").Dot("validateCredentialChangeRequest").Callln(
					constants.CtxVar(),
			...
			utils.BuildSubTest(
				...
				jen.Line(),
				jen.ID("mockDB").Assign().Qual(proj.DatabasePackage(), "BuildMockDatabase").Call(),
				jen.ID("mockDB").Dot("UserDataManager").Dot("On").Call(jen.Lit("GetUser"), jen.Qual(constants.MockPkg, "Anything"), jen.ID(utils.BuildFakeVarName("User")).Dot("ID")).Dot("Return").Call(jen.Parens(jen.PointerTo().Qual(proj.TypesPackage(), "User")).Call(jen.Nil()), constants.ObligatoryError()),
				jen.ID("s").Dot("userDataManager").Equals().ID("mockDB"),
				jen.Line(),
				jen.List(jen.ID("actual"), jen.ID("sc")).Assign().ID("s").Dot("validateCredentialChangeRequest").Callln(
					constants.CtxVar(),
		...
		jen.Func().ID("TestService_ListHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("mockDB").Dot("UserDataManager").Dot("On").Call(
					...
					jen.Qual(constants.MockPkg, "Anything"),
					jen.Qual(constants.MockPkg, "Anything"),
				).Dot("Return").Call(jen.Parens(jen.PointerTo().Qual(proj.TypesPackage(), "UserList")).Call(jen.Nil()), constants.ObligatoryError()),
				jen.ID("s").Dot("userDataManager").Equals().ID("mockDB"),
				jen.Line(),
				jen.List(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)).Assign().List(jen.ID("httptest").Dot("NewRecorder").Call(), jen.ID("buildRequest").Call(jen.ID("t"))),
				jen.ID("s").Dot("ListHandler").Call(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)),
	...
	lines := []jen.Code{
		jen.Func().ID("TestService_CreateHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.Line(),
				jen.ID("auth").Assign().AddressOf().Qual(proj.InternalAuthPackage("mock"), "Authenticator").Values(),
				jen.Qual(proj.InternalAuthPackage(), "On").Call(
			...
			jen.Line(),
			utils.BuildSubTestWithoutContext(
				"with error generating two factor secret",
				jen.ID("s").Assign().ID("buildTestService").Call(jen.ID("t")),
				jen.Line(),
				utils.BuildFakeVar(proj, "User"),
				utils.BuildFakeVarWithCustomName(proj, "exampleInput", "BuildFakeUserCreationInputFromUser", jen.ID(utils.BuildFakeVarName("User"))),
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.Line(),
				jen.ID("sg").Assign().AddressOf().ID("mockSecretGenerator").Values(),
				jen.ID("sg").Dot("On").Call(jen.Lit("GenerateTwoFactorSecret")).Dot("Return").Call(jen.Lit("PRETENDTHISISASECRET"), jen.Nil()),
				jen.ID("sg").Dot("On").Call(jen.Lit("GenerateSalt")).Dot("Return").Call(jen.Index().Byte().Values(), constants.ObligatoryError()),
				jen.ID("s").Dot("secretGenerator").Equals().ID("sg"),
				jen.Line(),
				jen.List(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)).Assign().List(jen.ID("httptest").Dot("NewRecorder").Call(), jen.ID("buildRequest").Call(jen.ID("t"))),
				jen.ID(constants.RequestVarName).Equals().ID(constants.RequestVarName).Dot("WithContext").Callln(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("db").Dot("UserDataManager").Dot("On").Call(
					...
					jen.Qual(constants.MockPkg, "Anything"),
					jen.Qual(constants.MockPkg, "AnythingOfType").Call(jen.Lit("models.UserDatabaseCreationInput")),
				).Dot("Return").Call(jen.ID(utils.BuildFakeVarName("User")), jen.Qual(proj.DatabasePackage("client"), "ErrUserExists")),
				jen.ID("s").Dot("userDataManager").Equals().ID("db"),
				jen.Line(),
				jen.List(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)).Assign().List(jen.ID("httptest").Dot("NewRecorder").Call(), jen.ID("buildRequest").Call(jen.ID("t"))),
				jen.ID(constants.RequestVarName).Equals().ID(constants.RequestVarName).Dot("WithContext").Callln(
	...
	lines := []jen.Code{
		jen.Func().ID("TestService_NewTOTPSecretHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("s").Dot("encoderDecoder").Equals().ID("ed"),
				jen.Line(),
				jen.ID("s").Dot("NewTOTPSecretHandler").Call(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)),
				jen.Line(),
	...
	lines := []jen.Code{
		jen.Func().ID("TestService_TOTPSecretValidationHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("s").Dot("userDataManager").Equals().ID("mockDB"),
				jen.Line(),
				jen.ID("s").Dot("TOTPSecretVerificationHandler").Call(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)),
				jen.Line(),
				utils.AssertEqual(jen.Qual("net/http", "StatusAccepted"), jen.ID(constants.ResponseVarName).Dot("Code"), nil),
				jen.Line(),
				utils.AssertExpectationsFor("mockDB"),
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("mockDB").Dot("UserDataManager").Dot("On").Call(
					...
					jen.Parens(jen.PointerTo().Qual(proj.TypesPackage(), "User")).Parens(jen.Nil()),
	...
	lines := []jen.Code{
		jen.Func().ID("TestService_UpdatePasswordHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("s").Dot("authenticator").Equals().ID("auth"),
				jen.Line(),
				jen.ID("s").Dot("UpdatePasswordHandler").Call(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)),
				jen.Line(),
				utils.AssertEqual(jen.Qual("net/http", "StatusAccepted"), jen.ID(constants.ResponseVarName).Dot("Code"), nil),
				jen.Line(),
				utils.AssertExpectationsFor("mockDB", "auth"),
