		...
		jen.Func().ID("TestAuthenticationService_issueSessionManagedCookie").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.List(jen.ID("expectedToken"), jen.ID("err")).Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/random", "GenerateBase64EncodedString").Call(
					...
					jen.ID("sm").Op(":=").Op("&").ID("mockSessionManager").Values(),
		...
		jen.Func().ID("TestAuthenticationService_LoginHandler").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("userDataManager").Op(":=").Op("&").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/pkg/types/mock", "UserDataManager").Values(),
					...
					jen.ID("authenticator").Op(":=").Op("&").ID("authentication").Dot("MockAuthenticator").Values(),
					...
					jen.ID("membershipDB").Op(":=").Op("&").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/pkg/types/mock", "AccountUserMembershipDataManager").Values(),
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("jsonBytes").Op(":=").ID("helper").Dot("service").Dot("encoderDecoder").Dot("MustEncode").Call(
						jen.ID("helper").Dot("ctx"),
						jen.Op("&").ID("types").Dot("UserLoginInput").Values(),
					),
					jen.Var().Defs(
						jen.ID("err").ID("error"),
					),
		...
		jen.Func().ID("TestAuthenticationService_ChangeActiveAccountHandler").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("accountMembershipManager").Op(":=").Op("&").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/pkg/types/mock", "AccountUserMembershipDataManager").Values(),
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("exampleInput").Op(":=").Op("&").ID("types").Dot("ChangeActiveAccountInput").Values(),
					jen.ID("jsonBytes").Op(":=").ID("helper").Dot("service").Dot("encoderDecoder").Dot("MustEncode").Call(
						jen.ID("helper").Dot("ctx"),
						jen.ID("exampleInput"),
					),
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("helper").Dot("service").Dot("accountMembershipManager").Op("=").ID("accountMembershipManager"),
					jen.ID("cookieManager").Op(":=").Op("&").ID("mockCookieEncoderDecoder").Values(),
		...
		jen.Func().ID("TestAuthenticationService_PASETOHandler").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("apiClientDataManager").Op(":=").Op("&").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/pkg/types/mock", "APIClientDataManager").Values(),
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("helper").Dot("service").Dot("config").Dot("PASETO").Dot("LocalModeKey").Op("=").ID("fakes").Dot("BuildFakeAPIClient").Call().Dot("ClientSecret"),
					jen.ID("helper").Dot("service").Dot("config").Dot("PASETO").Dot("Lifetime").Op("=").Qual("time", "Minute"),
					jen.ID("exampleInput").Op(":=").Op("&").ID("types").Dot("PASETOCreationInput").Values(),
					jen.ID("helper").Dot("service").Dot("encoderDecoder").Op("=").ID("encoding").Dot("ProvideServerEncoderDecoder").Call(
						jen.ID("logging").Dot("NewNoopLogger").Call(),
						jen.ID("encoding").Dot("ContentTypeJSON"),
					),
