...
func optionsDotGo(proj *models.Project) *jen.File {
	...
	code.Add(
		jen.Null().Type().ID("option").Params(jen.Op("*").ID("Client")).Params(jen.ID("error")),
		jen.Line(),
	)
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().ID("UsingJSON").Params().Params(jen.Params(jen.Op("*").ID("Client")).Params(jen.ID("error"))).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().ID("UsingXML").Params().Params(jen.Params(jen.Op("*").ID("Client")).Params(jen.ID("error"))).Body(
			jen.Return().Func().Params(jen.ID("c").Op("*").ID("Client")).Params(jen.ID("error")).Body(
				jen.List(jen.ID("requestBuilder"), jen.ID("err")).Op(":=").ID("requests").Dot("NewBuilder").Call(
					jen.ID("c").Dot("url"),
					jen.ID("c").Dot("logger"),
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().ID("UsingLogger").Params(jen.ID("logger").ID("logging").Dot("Logger")).Params(jen.Params(jen.Op("*").ID("Client")).Params(jen.ID("error"))).Body(
			jen.Return().Func().Params(jen.ID("c").Op("*").ID("Client")).Params(jen.ID("error")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().ID("UsingDebug").Params(jen.ID("debug").ID("bool")).Params(jen.Params(jen.Op("*").ID("Client")).Params(jen.ID("error"))).Body(
			jen.Return().Func().Params(jen.ID("c").Op("*").ID("Client")).Params(jen.ID("error")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().ID("UsingTimeout").Params(jen.ID("timeout").Qual("time", "Duration")).Params(jen.Params(jen.Op("*").ID("Client")).Params(jen.ID("error"))).Body(
			jen.Return().Func().Params(jen.ID("c").Op("*").ID("Client")).Params(jen.ID("error")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().ID("UsingCookie").Params(jen.ID("cookie").Op("*").Qual("net/http", "Cookie")).Params(jen.Params(jen.Op("*").ID("Client")).Params(jen.ID("error"))).Body(
			jen.Return().Func().Params(jen.ID("c").Op("*").ID("Client")).Params(jen.ID("error")).Body(
	...
	code.Add(
		...
		jen.Line(),
		jen.Func().ID("UsingPASETO").Params(jen.ID("clientID").ID("string"), jen.ID("secretKey").Index().ID("byte")).Params(jen.Params(jen.Op("*").ID("Client")).Params(jen.ID("error"))).Body(
			jen.Return().Func().Params(jen.ID("c").Op("*").ID("Client")).Params(jen.ID("error")).Body(
