...
func wireParamFetchersDotGo() *jen.File {
	...
	ret.Add(
		jen.Var().ID("paramFetcherProviders").Op("=").ID("wire").Dot(
			"NewSet",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("ProvideUserIDFetcher").Params().Params(jen.ID("items").Dot(
			"UserIDFetcher",
		)).Block(
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("ProvideItemIDFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("ProvideUsernameFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("ProvideAuthUserIDFetcher").Params().Params(jen.ID("auth").Dot(
			"UserIDFetcher",
		)).Block(
			jen.Return().ID("UserIDFetcher"),
		),
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("ProvideWebhooksUserIDFetcher").Params().Params(jen.ID("webhooks").Dot(
			"UserIDFetcher",
		)).Block(
			jen.Return().ID("UserIDFetcher"),
		),
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("ProvideWebhookIDFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("ProvideOAuth2ServiceClientIDFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("buildChiUserIDFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
		)).Params(jen.ID("users").Dot(
			"UserIDFetcher",
		)).Block(
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("buildChiItemIDFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("buildChiWebhookIDFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
		)).Params(jen.Params(jen.ID("req").Op("*").Qual("net/http", "Request")).Params(jen.ID("uint64"))).Block(
			jen.Return().Func().Params(jen.ID("req").Op("*").Qual("net/http", "Request")).Params(jen.ID("uint64")).Block(
				jen.List(jen.ID("u"), jen.ID("err")).Op(":=").Qual("strconv", "ParseUint").Call(jen.ID("chi").Dot(
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().ID("buildChiOAuth2ClientIDFetcher").Params(jen.ID("logger").Qual("gitlab.com/verygoodsoftwarenotvirus/logging/v1",
			"Logger",
		)).Params(jen.Params(jen.ID("req").Op("*").Qual("net/http", "Request")).Params(jen.ID("uint64"))).Block(
			jen.Return().Func().Params(jen.ID("req").Op("*").Qual("net/http", "Request")).Params(jen.ID("uint64")).Block(
				jen.List(jen.ID("u"), jen.ID("err")).Op(":=").Qual("strconv", "ParseUint").Call(jen.ID("chi").Dot(
