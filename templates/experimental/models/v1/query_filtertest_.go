...
func queryFilterTestDotGo() *jen.File {
	...
	ret.Add(jen.Func().ID("TestFromParams").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestQueryFilter_SetPage").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestQueryFilter_QueryPage").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
	...
	ret.Add(jen.Func().ID("TestQueryFilter_ToValues").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
		...
		jen.ID("T").Dot(
			"Run",
		).Call(jen.Lit("with nil"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
	...
	ret.Add(jen.Func().ID("TestQueryFilter_ApplyToQueryBuilder").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("baseQueryBuilder").Op(":=").ID("squirrel").Dot(
			"StatementBuilder",
		).Dot(
			"PlaceholderFormat",
			...
			"Select",
		).Call(jen.Lit("things")).Dot(
			"From",
		).Call(jen.Lit("stuff")).Dot(
			"Where",
		).Call(jen.ID("squirrel").Dot(
			"Eq",
		...
		jen.ID("T").Dot(
			"Run",
		).Call(jen.Lit("basic usecase"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
		...
		jen.ID("T").Dot(
			"Run",
		).Call(jen.Lit("returns query builder if query filter is nil"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
		...
		jen.ID("T").Dot(
			"Run",
		).Call(jen.Lit("whole kit and kaboodle"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
		...
		jen.ID("T").Dot(
			"Run",
		).Call(jen.Lit("with zero limit"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
	...
	ret.Add(jen.Func().ID("TestExtractQueryFilter").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
		jen.ID("T").Dot(
			"Parallel",
		).Call(),
		jen.ID("T").Dot(
