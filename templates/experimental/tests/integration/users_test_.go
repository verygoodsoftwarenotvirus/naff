			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("expectedAuditLogEntries").Op(":=").Index().Op("*").ID("types").Dot("AuditLogEntry").Valuesln(jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("AccountCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserAddedToAccountEvent"))),
			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("createdUserIDs").Op(":=").Index().ID("uint64").Valuesln(),
			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("expectedAuditLogEntries").Op(":=").Index().Op("*").ID("types").Dot("AuditLogEntry").Valuesln(jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("AccountCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserAddedToAccountEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserArchiveEvent"))),
						jen.ID("validateAuditLogEntries").Call(
							jen.ID("t"),
							jen.ID("expectedAuditLogEntries"),
							jen.ID("auditLogEntries"),
			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("expectedAuditLogEntries").Op(":=").Index().Op("*").ID("types").Dot("AuditLogEntry").Valuesln(jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserAddedToAccountEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("AccountCreationEvent"))),
						jen.ID("validateAuditLogEntries").Call(
							jen.ID("t"),
							jen.ID("expectedAuditLogEntries"),
							jen.ID("auditLogEntries"),
			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("expectedAuditLogEntries").Op(":=").Index().Op("*").ID("types").Dot("AuditLogEntry").Valuesln(jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("AccountCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserAddedToAccountEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserVerifyTwoFactorSecretEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("SuccessfulLoginEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("APIClientCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("UserUpdateEvent"))),
						jen.ID("validateAuditLogEntries").Call(
							jen.ID("t"),
							jen.ID("expectedAuditLogEntries"),
							jen.ID("auditLogEntries"),
