			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("expectedAuditLogEntries").Op(":=").Index().Op("*").ID("types").Dot("AuditLogEntry").Valuesln(jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("WebhookCreationEvent"))),
			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("expectedAuditLogEntries").Op(":=").Index().Op("*").ID("types").Dot("AuditLogEntry").Valuesln(jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("WebhookCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("WebhookUpdateEvent"))),
						jen.ID("validateAuditLogEntries").Call(
							jen.ID("t"),
							jen.ID("expectedAuditLogEntries"),
							jen.ID("auditLogEntries"),
			...
			jen.ID("s").Dot("runForEachClientExcept").Call(
				...
				jen.Func().Params(jen.ID("testClients").Op("*").ID("testClientWrapper")).Params(jen.Params()).Body(
					jen.Return().Func().Params().Body(
						...
						jen.ID("expectedAuditLogEntries").Op(":=").Index().Op("*").ID("types").Dot("AuditLogEntry").Valuesln(jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("WebhookCreationEvent")), jen.Valuesln(jen.ID("EventType").Op(":").ID("audit").Dot("WebhookArchiveEvent"))),
						jen.ID("validateAuditLogEntries").Call(
							jen.ID("t"),
							jen.ID("expectedAuditLogEntries"),
							jen.ID("auditLogEntries"),
