...
func itemsServiceDotGo() *jen.File {
	...
	ret.Add(jen.Func().Comment("// ProvideItemsService builds a new ItemsService").ID("ProvideItemsService").Params(jen.ID("ctx").Qual("context", "Context"), jen.ID("logger").ID("logging").Dot(
		"Logger",
