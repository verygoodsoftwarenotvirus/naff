...
func itemsDotGo() *jen.File {
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("GetItem").Params(jen.ID("ctx").Qual("context", "Context"), jen.List(jen.ID("itemID"), jen.ID("userID")).ID("uint64")).Params(jen.Op("*").ID("models").Dot(
			"Item",
		), jen.ID("error")).Block(
	...
	jen.Line(),
	jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("GetItemCount").Params(jen.ID("ctx").Qual("context", "Context"), jen.ID("filter").Op("*").ID("models").Dot(
		"QueryFilter",
	...
	jen.Line(),
	jen.Func().Comment("// This query only gets generated once, and is otherwise returned from cache.").Params(jen.ID("s").Op("*").ID("Sqlite")).ID("buildGetAllItemsCountQuery").Params().Params(jen.ID("string")).Block(
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("GetAllItemsCount").Params(jen.ID("ctx").Qual("context", "Context")).Params(jen.ID("count").ID("uint64"), jen.ID("err").ID("error")).Block(
			jen.ID("err").Op("=").ID("s").Dot(
				"db",
			).Dot(
				"QueryRowContext",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("GetItems").Params(jen.ID("ctx").Qual("context", "Context"), jen.ID("filter").Op("*").ID("models").Dot(
			"QueryFilter",
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("GetAllItemsForUser").Params(jen.ID("ctx").Qual("context", "Context"), jen.ID("userID").ID("uint64")).Params(jen.Index().ID("models").Dot(
			"Item",
		), jen.ID("error")).Block(
			jen.List(jen.ID("query"), jen.ID("args")).Op(":=").ID("s").Dot(
				"buildGetItemsQuery",
	...
	jen.Line(),
	jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("buildCreateItemQuery").Params(jen.ID("input").Op("*").ID("models").Dot(
		"Item",
	...
	jen.Comment("buildCreateItemQuery takes an item and returns a creation query for that item and the relevant arguments."),
	jen.Line(),
	jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("buildItemCreationTimeQuery").Params(jen.ID("itemID").ID("uint64")).Params(jen.ID("query").ID("string"), jen.ID("args").Index().Interface()).Block(
	...
	ret.Add(
		jen.Func().Comment("// buildUpdateItemQuery takes an item and returns an update SQL query, with the relevant query parameters").Params(jen.ID("s").Op("*").ID("Sqlite")).ID("buildUpdateItemQuery").Params(jen.ID("input").Op("*").ID("models").Dot(
		"Item",
	)).Params(jen.ID("query").ID("string"), jen.ID("args").Index().Interface()).Block(
	...
	jen.Line(),
	jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("UpdateItem").Params(jen.ID("ctx").Qual("context", "Context"), jen.ID("input").Op("*").ID("models").Dot(
		"Item",
	...
	jen.Line(),
	jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("buildArchiveItemQuery").Params(jen.List(jen.ID("itemID"), jen.ID("userID")).ID("uint64")).Params(jen.ID("query").ID("string"), jen.ID("args").Index().Interface()).Block(
	...
	ret.Add(
		...
		jen.Line(),
		jen.Func().Params(jen.ID("s").Op("*").ID("Sqlite")).ID("ArchiveItem").Params(jen.ID("ctx").Qual("context", "Context"), jen.List(jen.ID("itemID"), jen.ID("userID")).ID("uint64")).Params(jen.ID("error")).Block(
			jen.List(jen.ID("query"), jen.ID("args")).Op(":=").ID("s").Dot(
