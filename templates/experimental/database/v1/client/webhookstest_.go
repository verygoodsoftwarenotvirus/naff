	...
	ret.Add(
		jen.Func().ID("TestClient_GetWebhook").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("T").Dot("Run").Call(jen.Lit("happy path"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.ID("mockDB").Dot(
					"WebhookDataManager",
				).Dot("On").Call(jen.Lit("GetWebhook"), jen.Qual("github.com/stretchr/testify/mock",
					"Anything",
				),
	...
	ret.Add(
		jen.Func().ID("TestClient_GetWebhookCount").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("T").Dot("Run").Call(jen.Lit("happy path"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.ID("mockDB").Dot(
					"WebhookDataManager",
				).Dot("On").Call(jen.Lit("GetWebhookCount"), jen.Qual("github.com/stretchr/testify/mock",
					"Anything",
				),
					jen.ID("models").Dot(
						"DefaultQueryFilter",
	...
	ret.Add(
		jen.Func().ID("TestClient_GetAllWebhooksCount").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("T").Dot("Run").Call(jen.Lit("happy path"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.ID("mockDB").Dot(
					"WebhookDataManager",
				).Dot("On").Call(jen.Lit("GetAllWebhooksCount"), jen.Qual("github.com/stretchr/testify/mock",
					"Anything",
				)).Dot(
					"Return",
				).Call(jen.ID("expected"), jen.ID("nil")),
	...
	ret.Add(
		jen.Func().ID("TestClient_GetWebhooks").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("T").Dot("Run").Call(jen.Lit("happy path"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.ID("mockDB").Dot(
					"WebhookDataManager",
				).Dot("On").Call(jen.Lit("GetWebhooks"), jen.Qual("github.com/stretchr/testify/mock",
					"Anything",
				),
					jen.ID("models").Dot(
						"DefaultQueryFilter",
	...
	ret.Add(
		jen.Func().ID("TestClient_CreateWebhook").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("T").Dot("Run").Call(jen.Lit("happy path"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.ID("mockDB").Dot(
					"WebhookDataManager",
				).Dot("On").Call(jen.Lit("CreateWebhook"), jen.Qual("github.com/stretchr/testify/mock",
					"Anything",
				),
	...
	ret.Add(
		jen.Func().ID("TestClient_UpdateWebhook").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("T").Dot("Run").Call(jen.Lit("happy path"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.ID("mockDB").Dot(
					"WebhookDataManager",
				).Dot("On").Call(jen.Lit("UpdateWebhook"), jen.Qual("github.com/stretchr/testify/mock",
					"Anything",
				),
					jen.ID("exampleInput")).Dot(
					"Return",
	...
	ret.Add(
		jen.Func().ID("TestClient_ArchiveWebhook").Params(jen.ID("T").Op("*").Qual("testing", "T")).Block(
			...
			jen.ID("T").Dot("Run").Call(jen.Lit("happy path"), jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Block(
				...
				jen.ID("mockDB").Dot(
					"WebhookDataManager",
				).Dot("On").Call(jen.Lit("ArchiveWebhook"), jen.Qual("github.com/stretchr/testify/mock",
					"Anything",
				),
					jen.ID("exampleID"), jen.ID("exampleUserID")).Dot(
					"Return",
