		...
		jen.Func().ID("TestQuerier_LogUserBanEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildUserBanEventEntry").Call(
		...
		jen.Func().ID("TestQuerier_LogAccountTerminationEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					...
					jen.ID("exampleUser").Op(":=").ID("fakes").Dot("BuildFakeUser").Call(),
					jen.ID("exampleReason").Op(":=").Lit("smells bad"),
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildAccountTerminationEventEntry").Call(
						jen.ID("exampleServiceAdmin").Dot("ID"),
						jen.ID("exampleUser").Dot("ID"),
						jen.ID("exampleReason"),
					),
		...
		jen.Func().ID("TestQuerier_LogCycleCookieSecretEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					jen.ID("t").Dot("Parallel").Call(),
					jen.ID("exampleUser").Op(":=").ID("fakes").Dot("BuildFakeUser").Call(),
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildCycleCookieSecretEvent").Call(jen.ID("exampleUser").Dot("ID")),
					jen.ID("ctx").Op(":=").Qual("context", "Background").Call(),
					jen.List(jen.ID("c"), jen.ID("db")).Op(":=").ID("buildTestClient").Call(jen.ID("t")),
					jen.ID("mockQueryBuilder").Op(":=").ID("database").Dot("BuildMockSQLQueryBuilder").Call(),
					jen.ID("prepareForAuditLogEntryCreation").Call(
		...
		jen.Func().ID("TestQuerier_LogSuccessfulLoginEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					jen.ID("t").Dot("Parallel").Call(),
					jen.ID("exampleUser").Op(":=").ID("fakes").Dot("BuildFakeUser").Call(),
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildSuccessfulLoginEventEntry").Call(jen.ID("exampleUser").Dot("ID")),
					jen.ID("ctx").Op(":=").Qual("context", "Background").Call(),
					jen.List(jen.ID("c"), jen.ID("db")).Op(":=").ID("buildTestClient").Call(jen.ID("t")),
					jen.ID("mockQueryBuilder").Op(":=").ID("database").Dot("BuildMockSQLQueryBuilder").Call(),
					jen.ID("prepareForAuditLogEntryCreation").Call(
		...
		jen.Func().ID("TestQuerier_LogBannedUserLoginAttemptEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					jen.ID("t").Dot("Parallel").Call(),
					jen.ID("exampleUser").Op(":=").ID("fakes").Dot("BuildFakeUser").Call(),
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildBannedUserLoginAttemptEventEntry").Call(jen.ID("exampleUser").Dot("ID")),
					jen.ID("ctx").Op(":=").Qual("context", "Background").Call(),
					jen.List(jen.ID("c"), jen.ID("db")).Op(":=").ID("buildTestClient").Call(jen.ID("t")),
					jen.ID("mockQueryBuilder").Op(":=").ID("database").Dot("BuildMockSQLQueryBuilder").Call(),
					jen.ID("prepareForAuditLogEntryCreation").Call(
		...
		jen.Func().ID("TestQuerier_LogUnsuccessfulLoginBadPasswordEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					jen.ID("t").Dot("Parallel").Call(),
					jen.ID("exampleUser").Op(":=").ID("fakes").Dot("BuildFakeUser").Call(),
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildUnsuccessfulLoginBadPasswordEventEntry").Call(jen.ID("exampleUser").Dot("ID")),
					jen.ID("ctx").Op(":=").Qual("context", "Background").Call(),
					jen.List(jen.ID("c"), jen.ID("db")).Op(":=").ID("buildTestClient").Call(jen.ID("t")),
					jen.ID("mockQueryBuilder").Op(":=").ID("database").Dot("BuildMockSQLQueryBuilder").Call(),
					jen.ID("prepareForAuditLogEntryCreation").Call(
		...
		jen.Func().ID("TestQuerier_LogUnsuccessfulLoginBad2FATokenEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					jen.ID("t").Dot("Parallel").Call(),
					jen.ID("exampleUser").Op(":=").ID("fakes").Dot("BuildFakeUser").Call(),
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildUnsuccessfulLoginBad2FATokenEventEntry").Call(jen.ID("exampleUser").Dot("ID")),
					jen.ID("ctx").Op(":=").Qual("context", "Background").Call(),
					jen.List(jen.ID("c"), jen.ID("db")).Op(":=").ID("buildTestClient").Call(jen.ID("t")),
					jen.ID("mockQueryBuilder").Op(":=").ID("database").Dot("BuildMockSQLQueryBuilder").Call(),
					jen.ID("prepareForAuditLogEntryCreation").Call(
		...
		jen.Func().ID("TestQuerier_LogLogoutEvent").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			...
			jen.ID("T").Dot("Run").Call(
				...
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
					jen.ID("t").Dot("Parallel").Call(),
					jen.ID("exampleUser").Op(":=").ID("fakes").Dot("BuildFakeUser").Call(),
					jen.ID("exampleAuditLogEntry").Op(":=").Qual("gitlab.com/verygoodsoftwarenotvirus/todo/internal/audit", "BuildLogoutEventEntry").Call(jen.ID("exampleUser").Dot("ID")),
					jen.ID("ctx").Op(":=").Qual("context", "Background").Call(),
					jen.List(jen.ID("c"), jen.ID("db")).Op(":=").ID("buildTestClient").Call(jen.ID("t")),
					jen.ID("mockQueryBuilder").Op(":=").ID("database").Dot("BuildMockSQLQueryBuilder").Call(),
					jen.ID("prepareForAuditLogEntryCreation").Call(
