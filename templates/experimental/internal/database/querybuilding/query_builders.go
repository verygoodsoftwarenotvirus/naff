...
func queryBuildersDotGo(proj *models.Project) *jen.File {
	...
	code.Add(
		jen.Null().Type().ID("AccountSQLQueryBuilder").Interface(
		...
		).Type().ID("AccountUserMembershipSQLQueryBuilder").Interface(
		...
		).Type().ID("APIClientSQLQueryBuilder").Interface(
		...
		).Type().ID("AuditLogEntrySQLQueryBuilder").Interface(
		...
		).Type().ID("UserSQLQueryBuilder").Interface(
		...
		).Type().ID("WebhookSQLQueryBuilder").Interface(
		...
		).Type().ID("ItemSQLQueryBuilder").Interface(
		...
		).Type().ID("SQLQueryBuilder").Interface(
