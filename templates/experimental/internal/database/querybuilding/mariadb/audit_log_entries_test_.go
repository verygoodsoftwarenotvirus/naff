...
func auditLogEntriesTestDotGo(proj *models.Project) *jen.File {
	...
	code.Add(
		jen.Func().ID("TestMariaDB_BuildGetAuditLogEntryQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
	...
	code.Add(
		jen.Func().ID("TestMariaDB_BuildGetAllAuditLogEntriesCountQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			jen.ID("T").Dot("Parallel").Call(),
			jen.ID("T").Dot("Run").Call(
				jen.Lit("standard"),
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
	...
	code.Add(
		jen.Func().ID("TestMariaDB_BuildGetBatchOfAuditLogEntriesQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			jen.ID("T").Dot("Parallel").Call(),
			jen.ID("T").Dot("Run").Call(
				jen.Lit("standard"),
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
	...
	code.Add(
		jen.Func().ID("TestMariaDB_BuildGetAuditLogEntriesQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			jen.ID("T").Dot("Parallel").Call(),
			jen.ID("T").Dot("Run").Call(
				jen.Lit("standard"),
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
	...
	code.Add(
		jen.Func().ID("TestMariaDB_BuildCreateAuditLogEntryQuery").Params(jen.ID("T").Op("*").Qual("testing", "T")).Body(
			jen.ID("T").Dot("Parallel").Call(),
			jen.ID("T").Dot("Run").Call(
				jen.Lit("standard"),
				jen.Func().Params(jen.ID("t").Op("*").Qual("testing", "T")).Body(
