...
func spanAttachersDotGo(proj *models.Project) *jen.File {
	...
	code.Add(
		jen.Func().Comment("AttachFilterToSpan provides a consistent way to attach a filter's info to a span.").ID("AttachFilterToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("page").ID("uint64"), jen.ID("limit").ID("uint8"), jen.ID("sortBy").ID("string")).Body(
	...
	code.Add(
		jen.Func().Comment("AttachAccountIDToSpan provides a consistent way to attach an account's ID to a span.").ID("AttachAccountIDToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("accountID").ID("uint64")).Body(
			jen.ID("attachUint64ToSpan").Call(
				jen.ID("span"),
	...
	code.Add(
		jen.Func().Comment("AttachRequestingUserIDToSpan provides a consistent way to attach a user's ID to a span.").ID("AttachRequestingUserIDToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("userID").ID("uint64")).Body(
			jen.ID("attachUint64ToSpan").Call(
				jen.ID("span"),
	...
	code.Add(
		jen.Func().Comment("AttachAPIClientDatabaseIDToSpan is a consistent way to attach an API client's database row ID to a span.").ID("AttachAPIClientDatabaseIDToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("clientID").ID("uint64")).Body(
			jen.ID("attachUint64ToSpan").Call(
				jen.ID("span"),
	...
	code.Add(
		jen.Func().Comment("AttachAPIClientClientIDToSpan is a consistent way to attach an API client's ID to a span.").ID("AttachAPIClientClientIDToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("clientID").ID("string")).Body(
			jen.ID("attachStringToSpan").Call(
				jen.ID("span"),
	...
	code.Add(
		jen.Func().Comment("AttachUserIDToSpan provides a consistent way to attach a user's ID to a span.").ID("AttachUserIDToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("userID").ID("uint64")).Body(
			jen.ID("attachUint64ToSpan").Call(
				jen.ID("span"),
	...
	code.Add(
		jen.Func().Comment("AttachUsernameToSpan provides a consistent way to attach a user's username to a span.").ID("AttachUsernameToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("username").ID("string")).Body(
			jen.ID("attachStringToSpan").Call(
				jen.ID("span"),
	...
	code.Add(
		jen.Func().Comment("AttachWebhookIDToSpan provides a consistent way to attach a webhook's ID to a span.").ID("AttachWebhookIDToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("webhookID").ID("uint64")).Body(
			jen.ID("attachUint64ToSpan").Call(
				jen.ID("span"),
	...
	code.Add(
		jen.Func().Comment("AttachRequestToSpan attaches a given *http.Request to a span.").ID("AttachRequestToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("req").Op("*").Qual("net/http", "Request")).Body(
	...
	code.Add(
		jen.Func().Comment("AttachResponseToSpan attaches a given *http.Response to a span.").ID("AttachResponseToSpan").Params(jen.ID("span").ID("trace").Dot("Span"), jen.ID("res").Op("*").Qual("net/http", "Response")).Body(
