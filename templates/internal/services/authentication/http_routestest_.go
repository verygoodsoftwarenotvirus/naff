	...
	lines := []jen.Code{
		jen.Func().ID("TestService_fetchUserFromCookie").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.Line(),
				jen.ID("udb").Assign().AddressOf().Qual(proj.TypesPackage("mock"), "UserDataManager").Values(),
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("udb").Dot("On").Callln(
					...
					jen.Qual(constants.MockPkg, "Anything"),
					jen.ID(utils.BuildFakeVarName("User")).Dot("ID"),
				).Dot("Return").Call(jen.Parens(jen.PointerTo().Qual(proj.TypesPackage(), "User")).Call(jen.Nil()), jen.ID("expectedError")),
				jen.ID("s").Dot("userDB").Equals().ID("udb"),
				jen.Line(),
				jen.List(jen.ID("actualUser"), jen.Err()).Assign().ID("s").Dot("fetchUserFromCookie").Call(jen.ID(constants.RequestVarName).Dot("Context").Call(), jen.ID(constants.RequestVarName)),
				utils.AssertNil(jen.ID("actualUser"), nil),
	...
	lines := []jen.Code{
		jen.Func().ID("TestService_LoginHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("s").Dot("userDB").Equals().ID("udb"),
				jen.Line(),
				jen.ID("authr").Assign().AddressOf().Qual(proj.InternalAuthPackage("mock"), "Authenticator").Values(),
				...
				jen.Line(),
				jen.ID("s").Dot("LoginHandler").Call(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)),
				jen.Line(),
	...
	lines := []jen.Code{
		jen.Func().ID("TestService_LogoutHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID(constants.ResponseVarName).Assign().ID("httptest").Dot("NewRecorder").Call(),
				jen.Line(),
				jen.ID("s").Dot("LogoutHandler").Call(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)),
				jen.Line(),
		...
		jen.Func().ID("TestService_validateLogin").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTest(
				...
				jen.ID("authr").Dot("On").Callln(
					...
					jen.ID(utils.BuildFakeVarName("LoginData")).Dot("TOTPToken"),
					jen.ID(utils.BuildFakeVarName("User")).Dot("Salt"),
				).Dot("Return").Call(jen.True(), jen.Qual(proj.InternalAuthPackage(), "ErrCostTooLow")),
				jen.ID("s").Dot("authenticator").Equals().ID("authr"),
				jen.Line(),
				jen.ID("authr").Dot("On").Callln(
	...
	lines := []jen.Code{
		jen.Func().ID("TestService_StatusHandler").Params(jen.ID("T").PointerTo().Qual("testing", "T")).Body(
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("s").Dot("userDB").Equals().ID("udb"),
				jen.Line(),
				jen.ID("s").Dot("StatusHandler").Call(jen.ID(constants.ResponseVarName), jen.ID(constants.RequestVarName)),
				utils.AssertEqual(jen.Qual("net/http", "StatusOK"), jen.ID(constants.ResponseVarName).Dot("Code"), nil),
				jen.Line(),
				utils.AssertExpectationsFor("udb"),
			),
			...
			utils.BuildSubTestWithoutContext(
				...
				jen.ID("udb").Dot("On").Callln(
					...
					jen.Parens(jen.PointerTo().Qual(proj.TypesPackage(), "User")).Call(jen.Nil()),
