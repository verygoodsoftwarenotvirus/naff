...
func buildTestService() *Service {
	return &Service{
		...
		webhookIDFetcher: func(req *http.Request) uint64 {
			return 0
		},
...
func TestProvideWebhooksService(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := ProvideWebhooksService(context.Background(), noop.ProvideNoopLogger(), dm, func(req *http.Request) uint64 {
			return 0
		}, func(req *http.Request) uint64 {
			return 0
	...
	T.Run("with error providing counter", func(t *testing.T) {
		...
		actual, err := ProvideWebhooksService(context.Background(), noop.ProvideNoopLogger(), &mockmodels.WebhookDataManager{}, func(req *http.Request) uint64 {
			return 0
		}, func(req *http.Request) uint64 {
			return 0
		}, &mockencoding.EncoderDecoder{}, ucp, newsman.NewNewsman(nil, nil))
